 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    apto a votar\n",
    "    '''\n",
    "    def __init__(self, nome_morador, n_apto):\n",
    "        \n",
    "        '''\n",
    "        Construtor\n",
    "        \n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "paulo = Morador('Paulo', 60)\n",
    "bruna = Morador('Bruna', 60)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [
    {
     "ename": "NameError",
     "evalue": "name 'apto6' is not defined",
     "output_type": "error",
     "traceback": [
      "\u001b[1;31m---------------------------------------------------------------------------\u001b[0m",
      "\u001b[1;31mNameError\u001b[0m                                 Traceback (most recent call last)",
      "\u001b[1;32m<ipython-input-6-b912663f6083>\u001b[0m in \u001b[0;36m<module>\u001b[1;34m\u001b[0m\n\u001b[1;32m----> 1\u001b[1;33m \u001b[0mapto6\u001b[0m\u001b[1;33m\u001b[0m\u001b[1;33m\u001b[0m\u001b[0m\n\u001b[0m",
      "\u001b[1;31mNameError\u001b[0m: name 'apto6' is not defined"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    '''\n",
    "    def __init__(self, nome_morador, n_apto, id_candidato=0):\n",
    "        super().__init__(nome_morador, n_apto)\n",
    "        '''\n",
    "        Parametros\n",
    "        ----------\n",
    "        nome_morador: objeto Morador\n",
    "        \n",
    "        '''\n",
    "        self.objeto_candidato = nome_morador\n",
    "        self.id_candidato = 0\n",
    "        self.cont_voto = 0\n",
    "    \n",
    "    \n",
    "    def contagem_voto_urna(self, urna_predio):\n",
    "        \n",
    "        self.cont_voto = urna_predio.\n",
    "        "
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    ...
    "        self.cadastrante = []\n",
    "    \n",
    "    def cadastro_apto(self, objeto_apto, nome_morador):\n",
    "        '''\n",
    "        Para cadastrar um apartamento na urna\n",
    "        insira um Objeto Apartamento\n",
    "        \n",
    "        Parametros\n",
    "        ----------\n",
    "        objeto_apto : objeto Apartamento\n",
    "            apartamento que será cadastrado\n",
    "            \n",
    "        nome_morador : objeto Morador\n",
    "            Morador que cadastrou o apartamento na Urna\n",
    "        '''\n",
    "        if nome_morador.nome in objeto_apto.lista_nome_moradores:\n",
    "            self.list_apartamentos_total.append(objeto_apto)\n",
    "            self.cadastrante.append(nome_morador)\n",
    "            return 'O apartamento foi cadastrado com sucesso'\n",
    "        return f'Não há morador {nome_morador} no apartamento {objeto_apto.n_apto}'\n",
    "        \n",
    "    \n",
    "    def cadastro_candidato(self, objeto_apto, nome_candidato):\n",
    "        '''\n",
    "        Para cadastrar um candidato na urna\n",
    "        insira um objeto Candidato\n",
    "        \n",
    "        Parametros\n",
    "        ----------\n",
    "        objeto_apto : objeto Apartamento\n",
    ...
    "            \n",
    "        nome_candidato : objeto morador\n",
    "            candidato cadastrado\n",
    "            \n",
    "        Retorno\n",
    "        -------\n",
    "        Retorna o numero do candidato\n",
    "        que será atribuito como seu numero de apartamento\n",
    "        '''\n",
    "        \n",
    "        if nome_candidato.nome in objeto_apto.lista_nome_moradores:\n",
    "            \n",
    "            nome_candidato = Candidato(nome_candidato, nome_candidato.n_apto,len(self.list_candidatos)+1)\n",
    "            self.list_candidatos.append(nome_candidato)\n",
    "            \n",
    "            return 'O candidato foi cadastrado com sucesso'\n",
    "        return f'Não há candidato {nome_morador} no apartamento {objeto_apto.n_apto}'\n",
    "\n",
    "    \n",
    "    \n",
    "    def voto_apto(self, objeto_apto, nome_morador, id_candidato):\n",
    "        if objeto_apto.n_apto in self.list_aptos_votos:\n",
    "            return f'Já foi computado um voto do apartamento {objeto_apto.n_apto} pelo morador {nome_morador.nome}'\n",
    "        else:\n",
    "            self.list_voters.append(nome_morador.nome)\n",
    "            self.list_aptos_votos.append(objeto_apto.n_apto)\n",
    "            \n",
    "            return f'O voto foi computado com sucesso'\n",
    "            \n",
    "            \n",
    "        \n",
    "        \n",
  ...
  },
  {
   ...
   "source": [
    "urna1.cadastro_apto(apto1, paulo)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "'Já foi computado um voto do apartamento 60 pelo morador Paulo'"
      ]
     },
     "execution_count": 67,
     "metadata": {},
